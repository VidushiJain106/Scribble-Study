...
export async function fetchExplanationData(noteId: string, note: any) {
  ...
  try {
    console.log("Checking for existing explanation in database for noteId:", noteId);
    ...
    if (existingExplanation) {
      console.log("Using existing explanation from database", existingExplanation.id);
