...
export function FontFormatBar({ onFormatChange }: FontFormatBarProps) {
  ...
  return (
    <div className="bg-background border rounded-md p-1 flex flex-wrap gap-1 mb-2 items-center">
      {/* Text style toggles */}
